...
- (void)refresh{
    ...
    __weak typeof(RootTableViewController *) temp = self;
...
//        }];
        ...
        [[GetVideoDataTools shareDataTools] getHeardDataWithURL:kUrl HeardValue:^(NSArray *heardArray, NSArray *videoArray) {
